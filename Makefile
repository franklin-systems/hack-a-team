...
compile-schema:
	...
	npx composedb composite:compile ceramic/schema/hackathon.json ceramic/schema/runtime-composite.js
	cp ceramic/schema/runtime-composite.js frontend/src/schema/runtime-composite.js
